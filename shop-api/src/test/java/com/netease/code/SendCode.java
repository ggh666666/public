...
public class SendCode {
    ...
    //短信模板ID    不加则是短信
//    private static final String TEMPLATEID="14842183";
    //手机号
...
//        nvps.add(new BasicNameValuePair("templateid", TEMPLATEID));
    ...
    public static void sendCode2() throws IOException {

        //发送验证码的请求路径URL
        String SERVER_URL = "https://api.netease.im/sms/sendtemplate.action";
        //网易云信分配的账号，请替换你在管理后台应用下申请的Appkey
        String APP_KEY = "854154723a80cdf85fc757801c477c82";
        //网易云信分配的密钥，请替换你在管理后台应用下申请的appSecret
        String APP_SECRET = "11ed9411d835";
        //随机数
        String NONCE = "123456";
        //短信模板ID
        String TEMPLATEID = "3057527";
        //手机号，接收者号码列表，JSONArray格式，限制接收者号码个数最多为100个
        String MOBILES = "['15910933097',]";
